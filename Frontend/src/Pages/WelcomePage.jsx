    ...
    <>
      <Box>
        <Grid2 sx={{display:"flex", flexDirection:"column", gap:"2rem"}}>
          ...
          <Grid2 sx={{display:"flex", flexDirection:"row", justifyContent:"space-around", gap:"1rem"}}>
            <Typography variant="h6" boxShadow=" 0px 0px 3px 0px" padding="1rem" sx={{fontSize:"1.1rem", borderRadius:"10px"}}>
            ...
            <Typography variant="h6" boxShadow="0px 0px 3px 0px" padding="1rem" sx={{fontSize:"1.1rem", borderRadius:"10px"}}>
              ...
              of your time? *Sign up now* or *log in* to get started. Your
              productivity journey begins here!
            </Typography>
          </Grid2>
        </Grid2>
      </Box>
